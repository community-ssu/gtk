...
#ifdef SAVE_RCSID
static char rcsid =
 "@(#) $Id: SDL_x11video.c,v 1.17 2004/03/02 19:38:55 icculus Exp $";
#endif
...
static void foo_make_fullscreen(Display *dpy, Window win)
{
    Atom first, second;
...
static void create_aux_windows(_THIS)
{
    ...
    foo_make_fullscreen(SDL_Display, FSwindow);
