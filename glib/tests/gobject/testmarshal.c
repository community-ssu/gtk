...
/* BOOLEAN:INT (/home/tpalli/upgrade/glib_merge/commit/glib-2.12.4/tests/gobject/testmarshal.list:2) */
void
...
/* STRING:INT (/home/tpalli/upgrade/glib_merge/commit/glib-2.12.4/tests/gobject/testmarshal.list:3) */
void
