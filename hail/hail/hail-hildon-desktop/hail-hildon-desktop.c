...
HAIL_ACCESSIBLE_FACTORY (HAIL_TYPE_MENU_ITEM, hail_menu_item, hail_menu_item_new)
...
HAIL_ACCESSIBLE_FACTORY (HAIL_TYPE_DESKTOP_POPUP_WINDOW, hail_desktop_popup_window, hail_desktop_popup_window_new)
HAIL_ACCESSIBLE_FACTORY (HAIL_TYPE_DESKTOP_POPUP_MENU, hail_desktop_popup_menu, hail_desktop_popup_menu_new)

void
hail_hildon_desktop_init (void)
{
  HAIL_WIDGET_SET_FACTORY (GTK_TYPE_MENU_ITEM, hail_menu_item);
  ...
  HAIL_WIDGET_SET_FACTORY (HILDON_DESKTOP_TYPE_POPUP_WINDOW, hail_desktop_popup_window);
  HAIL_WIDGET_SET_FACTORY (HILDON_DESKTOP_TYPE_POPUP_MENU, hail_desktop_popup_menu);
}
