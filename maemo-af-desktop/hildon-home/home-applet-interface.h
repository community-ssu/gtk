...
#ifndef HOME_APPLET_API_H
#define HOME_APPLET_API_H
...
*/
void *home_applet_lib_initialize(void *state_data,
                                        int *state_size, 
                                        GtkWidget **widget);
...
*/
int home_applet_lib_save_state(void *applet_data,
...
/**  Called when Home goes to backround. 
     ...
     @param applet_data Applet data as returned by applet_initialize.
*/
void home_applet_lib_background(void *applet_data);
...
/**  Called when Home goes to foreground. 
     ...
     @param applet_data Applet data as returned by applet_initialize.
*/
void home_applet_lib_foreground(void *applet_data);
...
/**  Called when Home unloads the applet from memory.
     ...
     @param applet_data Applet data as returned by applet_initialize.
*/
void home_applet_lib_deinitialize(void *applet_data);
...
GtkWidget *home_applet_lib_properties(void *applet_data,
                                             GtkWindow *parent);
