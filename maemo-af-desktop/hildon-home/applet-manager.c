                                   ...
                                   gchar *desktoppath)
{
    ...
    {
        applet_manager_initialize(man, librarypath, desktoppath, 
                                  applet_x, applet_y, 
...
void applet_manager_configure_save_all(applet_manager_t *man)
{
        ...
        handler_listitem = handler_listitem->next)
    {
        ...
        g_key_file_set_integer(keyfile, desktop, APPLET_KEY_WIDTH,
                               applet_width);
        g_key_file_set_integer(keyfile, desktop, APPLET_KEY_HEIGHT,
                               applet_height);

        g_key_file_set_string(keyfile, desktop, APPLET_KEY_RESIZABLE, 
                              resizable);
...
void applet_manager_configure_load_all(applet_manager_t *man)
{
    ...
    while (groups[i] != NULL)
    {
        ...
        if (error != NULL || applet_width == APPLET_NONCHANGABLE_DIMENSION)
        {
        ...
        if (error != NULL || applet_height == APPLET_NONCHANGABLE_DIMENSION)
        {
        ...
        if (resizable != NULL)
        {
             if (g_str_equal (resizable, HOME_APPLET_RESIZABLE_FULL))
             {
                 ...
                 applet_resizable_height = TRUE;
                                   ...
                                   HOME_APPLET_RESIZABLE_WIDTH))
             {
                 applet_resizable_width = TRUE;
             }
             else if (g_str_equal (resizable,
                                   HOME_APPLET_RESIZABLE_HEIGHT))
             {
                 applet_resizable_height = TRUE;
             }
        }
        ...
        if(applet_resizable_width == TRUE)
        {
        ...
        if(applet_resizable_height == TRUE)
        {
                             ...
                             gint width, gint height)
{
    ...
    applet_manager_set_size_handler(man, handler, width, height);
}
                             ...
                             gint *width, gint *height)
{
    ...
    applet_manager_get_size_handler(man, handler, width, height);
}
                                     ...
                                     gint minwidth, gint minheight)
{
    ...
    applet_manager_set_minimum_size_handler(man, handler, minwidth, minheight);
}
                                     ...
                                     gint *minwidth, gint *minheight)
{
    ...
    applet_manager_get_minimum_size_handler(man, handler, minwidth, minheight);
}
                                  ...
                                  gboolean resizable_height)
{
    ...
    applet_manager_set_resizable_handler(man, handler, 
                                         resizable_width, resizable_height);
}
                                  ...
                                  gboolean *resizable_height)
{
    ...
    applet_manager_get_resizable_handler(man, handler, 
                                         resizable_width, resizable_height);
}
                                            ...
                                            gchar *identifier)
{
    ...
    applet_manager_get_resizable_handler(man, handler, &width, &height);
