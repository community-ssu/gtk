...
HNKeysActionConfLookup[] = 
{
  ...
  { HN_KEYS_GCONF_PATH "/F4",              HN_KEY_ACTION_SENDKEY_F4,
    hn_keys_action_send_key, (gpointer)XK_F4 },
  { HN_KEYS_GCONF_PATH "/F5",              HN_KEY_ACTION_SENDKEY_F5,
    hn_keys_action_send_key, (gpointer)XK_F5  },
  { HN_KEYS_GCONF_PATH "/F6",              HN_KEY_ACTION_SENDKEY_F6,
    hn_keys_action_send_key, (gpointer)XK_F6 },
  { HN_KEYS_GCONF_PATH "/F7",              HN_KEY_ACTION_SENDKEY_F7,
    hn_keys_action_send_key, (gpointer)XK_F7  },
  { HN_KEYS_GCONF_PATH "/F8",              HN_KEY_ACTION_SENDKEY_F8,
