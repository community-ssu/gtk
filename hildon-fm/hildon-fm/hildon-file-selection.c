                                              ...
                                              GtkTreeIter * main_iter)
{
    ...
    /* The iterator doesn't neccesarily appear in the filter.
       For example in case when it's hidden and we do not show hidden ones */
    main_path = gtk_tree_model_get_path(self->priv->main_model, main_iter);
    g_assert(main_path); /* This really have to succeed */
