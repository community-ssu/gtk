...
static void
hildon_file_system_special_location_class_init (HildonFileSystemSpecialLocationClass *klass);

static void
hildon_file_system_special_location_init (HildonFileSystemSpecialLocation *location);
 ...
 * to GtkFileInfo)
 * Pseudocode:
 * if (has_fixed_name) return fixed_name;
 * return virtual_function_result; */
gchar*
hildon_file_system_special_location_get_display_name (HildonFileSystemSpecialLocation *location, GtkFileSystem *fs)
{
 ...
 * Pseudocode:
 * if (subclass_get_extra_info) return subclass_get_extra_info;
 * return NULL; */
gchar*
hildon_file_system_special_location_get_extra_info (HildonFileSystemSpecialLocation *location)
{
    HildonFileSystemSpecialLocationClass *klass;
...
GdkPixbuf*
hildon_file_system_special_location_get_icon (HildonFileSystemSpecialLocation *location, GtkFileSystem *fs, GtkWidget *ref_widget, int size)
{
    HildonFileSystemSpecialLocationClass *klass;
...
gboolean
hildon_file_system_special_location_is_available (HildonFileSystemSpecialLocation *location)
{
    HildonFileSystemSpecialLocationClass *klass;
 ...
 * are visible. */
gboolean
hildon_file_system_special_location_is_visible (HildonFileSystemSpecialLocation *location)
{
    HildonFileSystemSpecialLocationClass *klass;
...
gchar*
hildon_file_system_special_location_get_unavailable_reason (HildonFileSystemSpecialLocation *location)
{
    HildonFileSystemSpecialLocationClass *klass;
...
gboolean
hildon_file_system_special_location_requires_access (HildonFileSystemSpecialLocation *location)
{
    HildonFileSystemSpecialLocationClass *klass;
...
gboolean
hildon_file_system_special_location_failed_access (HildonFileSystemSpecialLocation *location)
{
    HildonFileSystemSpecialLocationClass *klass;
...
void
hildon_file_system_special_location_set_display_name (HildonFileSystemSpecialLocation *location, const gchar *name)
{
    g_return_if_fail (HILDON_IS_FILE_SYSTEM_SPECIAL_LOCATION (location));
...
void
hildon_file_system_special_location_set_icon (HildonFileSystemSpecialLocation *location, const gchar *icon_name)
{
    g_return_if_fail (HILDON_IS_FILE_SYSTEM_SPECIAL_LOCATION (location));
