/*
 * dsock.c - OpenUNIX socket processing functions for lsof
 */
...
static char *rcsid = "$Id: dsock.c,v 1.5 2002/01/16 15:05:38 abe Exp $";
#endif
	...
	struct queue *q;		/* queue at end of stream */
{
	...
	int udp = 0;
/*
 * Process protocol specification and determine
 */
	Lf->inp_ty = 2;
