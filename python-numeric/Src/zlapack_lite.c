...
/*        Reduce rows and columns i:i+ib-1 to bidiagonal form and return   
	...
	i__3 = *m - i__ + 1;
	i__4 = *n - i__ + 1;
	zlabrd_(&i__3, &i__4, &nb, &a_ref(i__, i__), lda, &d__[i__], &e[i__], 
...
/*        Update the trailing submatrix A(i+ib:m,i+ib:n), using   
	...
	zgemm_("No transpose", "Conjugate transpose", &i__3, &i__4, &nb, &
		z__1, &a_ref(i__ + nb, i__), lda, &work[ldwrkx * nb + nb + 1],
		 &ldwrky, &c_b1, &a_ref(i__ + nb, i__ + nb), lda);
	i__3 = *m - i__ - nb + 1;
	i__4 = *n - i__ - nb + 1;
	z__1.r = -1., z__1.i = 0.;
	zgemm_("No transpose", "No transpose", &i__3, &i__4, &nb, &z__1, &
		work[nb + 1], &ldwrkx, &a_ref(i__, i__ + nb), lda, &c_b1, &
...
/*     Use unblocked code to reduce the remainder of the matrix */
    ...
    i__2 = *m - i__ + 1;
    i__1 = *n - i__ + 1;
    zgebd2_(&i__2, &i__1, &a_ref(i__, i__), lda, &d__[i__], &e[i__], &tauq[
...
/*           Reduce columns i:i+ib-1 to Hessenberg form, returning the   
	    ...
	    zlahrd_(ihi, &i__, &ib, &a_ref(1, i__), lda, &tau[i__], t, &c__65,
		     &work[1], &ldwork);
...
/*           Apply the block reflector H to A(1:ihi,i+ib:ihi) from the   
	    ...
	    zgemm_("No transpose", "Conjugate transpose", ihi, &i__3, &ib, &
		    z__1, &work[1], &ldwork, &a_ref(i__ + ib, i__), lda, &
...
/* Computing MIN */
	i__2 = i__ + 1;
	i__3 = *n - i__ + 1;
	zlarfg_(&i__3, &alpha, &a_ref(i__, min(i__2,*n)), lda, &tau[i__]);
	if (i__ < *m) {
...
/*           Apply H(i) to A(i+1:m,i:n) from the right */
	    ...
	    i__2 = *m - i__;
	    i__3 = *n - i__ + 1;
	    zlarf_("Right", &i__2, &i__3, &a_ref(i__, i__), lda, &tau[i__], &
	...
	integer *lwork, doublereal *rwork, integer *iwork, integer *info)
{
    ...
    static integer mnthr1, mnthr2, ie;
...
/*           Factor diagonal and subdiagonal blocks and test for exact   
	    ...
	    i__3 = *m - j + 1;
	    zgetf2_(&i__3, &jb, &a_ref(j, j), lda, &ipiv[j], &iinfo);
...
/*           Generate elementary reflector H(i) = I - tau * v * v'   
	    ...
	    i__1 = a_subscr(i__, i__ + 1);
	    alpha.r = a[i__1].r, alpha.i = a[i__1].i;
	    zlarfg_(&i__, &alpha, &a_ref(1, i__ + 1), &c__1, &taui);
	    i__1 = i__;
	    e[i__1] = alpha.r;
...
/*              Compute  x := tau * A * v  storing x in TAU(1:i) */
		...
		zhemv_(uplo, &i__, &taui, &a[a_offset], lda, &a_ref(1, i__ + 
			1), &c__1, &c_b2, &tau[1], &c__1);
...
/*              Compute  w := x - 1/2 * tau * (x'*v) * v */
		...
		zdotc_(&z__4, &i__, &tau[1], &c__1, &a_ref(1, i__ + 1), &c__1)
			;
		z__1.r = z__2.r * z__4.r - z__2.i * z__4.i, z__1.i = z__2.r * 
			z__4.i + z__2.i * z__4.r;
		alpha.r = z__1.r, alpha.i = z__1.i;
		zaxpy_(&i__, &alpha, &a_ref(1, i__ + 1), &c__1, &tau[1], &
			c__1);
...
/*              Apply the transformation as a rank-2 update:   
		...
		z__1.r = -1., z__1.i = 0.;
		zher2_(uplo, &i__, &z__1, &a_ref(1, i__ + 1), &c__1, &tau[1], 
			&c__1, &a[a_offset], lda);
...
/* Computing MIN */
	    i__2 = i__ + 2;
	    i__3 = *n - i__;
	    zlarfg_(&i__3, &alpha, &a_ref(min(i__2,*n), i__), &c__1, &taui);
	    i__2 = i__;
	    e[i__2] = alpha.r;
...
/*              Compute  x := tau * A * v  storing y in TAU(i:n-1) */
		...
		i__2 = *n - i__;
		zhemv_(uplo, &i__2, &taui, &a_ref(i__ + 1, i__ + 1), lda, &
			a_ref(i__ + 1, i__), &c__1, &c_b2, &tau[i__], &c__1);
...
/*              Compute  w := x - 1/2 * tau * (x'*v) * v */
		...
		z__2.r = z__3.r * taui.r - z__3.i * taui.i, z__2.i = z__3.r * 
			taui.i + z__3.i * taui.r;
		i__2 = *n - i__;
		zdotc_(&z__4, &i__2, &tau[i__], &c__1, &a_ref(i__ + 1, i__), &
			c__1);
		z__1.r = z__2.r * z__4.r - z__2.i * z__4.i, z__1.i = z__2.r * 
			z__4.i + z__2.i * z__4.r;
		alpha.r = z__1.r, alpha.i = z__1.i;
		i__2 = *n - i__;
		zaxpy_(&i__2, &alpha, &a_ref(i__ + 1, i__), &c__1, &tau[i__], 
			&c__1);
...
/*              Apply the transformation as a rank-2 update:   
		...
		i__2 = *n - i__;
		z__1.r = -1., z__1.i = 0.;
		zher2_(uplo, &i__2, &z__1, &a_ref(i__ + 1, i__), &c__1, &tau[
			i__], &c__1, &a_ref(i__ + 1, i__ + 1), lda)
			;

	    } else {
		i__2 = a_subscr(i__ + 1, i__ + 1);
		i__3 = a_subscr(i__ + 1, i__ + 1);
		d__1 = a[i__3].r;
...
/*           Update the unreduced submatrix A(1:i-1,1:i-1), using an   
	    ...
	    i__3 = i__ - 1;
	    z__1.r = -1., z__1.i = 0.;
	    zher2k_(uplo, "No transpose", &i__3, &nb, &z__1, &a_ref(1, i__), 
...
/*           Reduce columns i:i+nb-1 to tridiagonal form and form the   
	    ...
	    i__3 = *n - i__ + 1;
	    zlatrd_(uplo, &i__3, &nb, &a_ref(i__, i__), lda, &e[i__], &tau[
		    i__], &work[1], &ldwork);
...
/*           Update the unreduced submatrix A(i+nb:n,i+nb:n), using   
	    ...
	    i__3 = *n - i__ - nb + 1;
	    z__1.r = -1., z__1.i = 0.;
	    zher2k_(uplo, "No transpose", &i__3, &nb, &z__1, &a_ref(i__ + nb, 
...
/*        Use unblocked code to reduce the last or only block */
	...
	i__1 = *n - i__ + 1;
	zhetd2_(uplo, &i__1, &a_ref(i__, i__), lda, &d__[i__], &e[i__], &tau[
		i__], &iinfo);
    }
...
/*           Update A(1:n,i)   
	    ...
	    i__2 = i__ - 1;
	    zlacgv_(&i__2, &a_ref(*k + i__ - 1, 1), lda);
	    i__2 = i__ - 1;
	    z__1.r = -1., z__1.i = 0.;
	    zgemv_("No transpose", n, &i__2, &z__1, &y[y_offset], ldy, &a_ref(
...
/*           Apply I - V * T' * V' to this column (call it b) from the   
	    ...
	    i__2 = i__ - 1;
	    zcopy_(&i__2, &a_ref(*k + 1, i__), &c__1, &t_ref(1, *nb), &c__1);
	    i__2 = i__ - 1;
	    ztrmv_("Lower", "Conjugate transpose", "Unit", &i__2, &a_ref(*k + 
...
/*           w := w + V2'*b2 */
	    ...
	    i__2 = *n - *k - i__ + 1;
	    i__3 = i__ - 1;
	    zgemv_("Conjugate transpose", &i__2, &i__3, &c_b2, &a_ref(*k + 
...
/*           b2 := b2 - V2*w */
	    ...
	    i__3 = i__ - 1;
	    z__1.r = -1., z__1.i = 0.;
	    zgemv_("No transpose", &i__2, &i__3, &z__1, &a_ref(*k + i__, 1), 
...
/*           b1 := b1 - V1*w */
	    ...
	    i__2 = i__ - 1;
	    ztrmv_("Lower", "No transpose", "Unit", &i__2, &a_ref(*k + 1, 1), 
		    lda, &t_ref(1, *nb), &c__1);
	    i__2 = i__ - 1;
	    z__1.r = -1., z__1.i = 0.;
	    zaxpy_(&i__2, &z__1, &t_ref(1, *nb), &c__1, &a_ref(*k + 1, i__), &
		    c__1);
...
/* Computing MIN */
	i__2 = *k + i__ + 1;
	i__3 = *n - *k - i__ + 1;
	zlarfg_(&i__3, &ei, &a_ref(min(i__2,*n), i__), &c__1, &tau[i__]);
	i__2 = a_subscr(*k + i__, i__);
	a[i__2].r = 1., a[i__2].i = 0.;
...
/*        Compute  Y(1:n,i) */
	...
	i__2 = *n - *k - i__ + 1;
	zgemv_("No transpose", n, &i__2, &c_b2, &a_ref(1, i__ + 1), lda, &
		a_ref(*k + i__, i__), &c__1, &c_b1, &y_ref(1, i__), &c__1);
	i__2 = *n - *k - i__ + 1;
	i__3 = i__ - 1;
	zgemv_("Conjugate transpose", &i__2, &i__3, &c_b2, &a_ref(*k + i__, 1)
		, lda, &a_ref(*k + i__, i__), &c__1, &c_b1, &t_ref(1, i__), &
		c__1);
	i__2 = i__ - 1;
	z__1.r = -1., z__1.i = 0.;
	zgemv_("No transpose", n, &i__2, &z__1, &y[y_offset], ldy, &t_ref(1, 
		i__), &c__1, &c_b2, &y_ref(1, i__), &c__1);
	zscal_(n, &tau[i__], &y_ref(1, i__), &c__1);
...
/*        Compute T(1:i,i) */
	...
	zscal_(&i__2, &z__1, &t_ref(1, i__), &c__1);
	i__2 = i__ - 1;
...
/* L20: */
	...
	dgemm_("T", "N", &nl, nrhs, &nl, &c_b9, &u_ref(nlf, 1), ldu, &rwork[(
...
/* L80: */
	...
	dgemm_("T", "N", &nr, nrhs, &nr, &c_b9, &u_ref(nrf, 1), ldu, &rwork[(
...
/* L110: */
	    ...
	    for (j = 1; j <= i__1; ++j) {
		i__2 = *n - j;
		zlassq_(&i__2, &a_ref(j + 1, j), &c__1, &scale, &sum);
/* L120: */
	    }
	}
	sum *= 2;
...
/*           A is upper triangular. */
	    ...
	    for (j = 1; j <= i__1; ++j) {
		i__2 = j - 1;
		cnorm[j] = dzasum_(&i__2, &a_ref(1, j), &c__1);
/* L10: */
	    }
	} else {
...
/*           A is lower triangular. */
	    ...
	    for (j = 1; j <= i__1; ++j) {
		i__2 = *n - j;
		cnorm[j] = dzasum_(&i__2, &a_ref(j + 1, j), &c__1);
/* L20: */
	    }
	    cnorm[*n] = 0.;
	}
...
/*                    Compute the update   
			...
			zaxpy_(&i__3, &z__1, &a_ref(1, j), &c__1, &x[1], &
				c__1);
			i__3 = j - 1;
...
/*                    Compute the update   
			...
			z__2.r = -x[i__4].r, z__2.i = -x[i__4].i;
			z__1.r = tscal * z__2.r, z__1.i = tscal * z__2.i;
			zaxpy_(&i__3, &z__1, &a_ref(j + 1, j), &c__1, &x[j + 
				1], &c__1);
			i__3 = *n - j;
...
/*                 If the scaling needed for A in the dot product is 1,   
		    ...
		    if (upper) {
			i__3 = j - 1;
			zdotu_(&z__1, &i__3, &a_ref(1, j), &c__1, &x[1], &
				c__1);
			csumj.r = z__1.r, csumj.i = z__1.i;
		    } else if (j < *n) {
			i__3 = *n - j;
			zdotu_(&z__1, &i__3, &a_ref(j + 1, j), &c__1, &x[j + 
				1], &c__1);
			csumj.r = z__1.r, csumj.i = z__1.i;
		    }
		} else {
...
/*                 If the scaling needed for A in the dot product is 1,   
		    ...
		    if (upper) {
			i__3 = j - 1;
			zdotc_(&z__1, &i__3, &a_ref(1, j), &c__1, &x[1], &
				c__1);
			csumj.r = z__1.r, csumj.i = z__1.i;
		    } else if (j < *n) {
			i__3 = *n - j;
			zdotc_(&z__1, &i__3, &a_ref(j + 1, j), &c__1, &x[j + 
				1], &c__1);
			csumj.r = z__1.r, csumj.i = z__1.i;
		    }
		} else {
...
/*              Form Q(2:m,2:m) */
		...
		i__2 = *m - 1;
		i__3 = *m - 1;
		zungqr_(&i__1, &i__2, &i__3, &a_ref(2, 2), lda, &tau[1], &
			work[1], lwork, &iinfo);
	    }
	}
    } else {
...
/*              Form P'(2:n,2:n) */
		...
		i__2 = *n - 1;
		i__3 = *n - 1;
		zunglq_(&i__1, &i__2, &i__3, &a_ref(2, 2), lda, &tau[1], &
			work[1], lwork, &iinfo);
	    }
	}
    }
...
/*        Apply H(i)' to A(i:m,i:n) from the right */
	...
	if (i__ < *n) {
	    i__1 = *n - i__;
	    zlacgv_(&i__1, &a_ref(i__, i__ + 1), lda);
	    if (i__ < *m) {
		i__1 = a_subscr(i__, i__);
		a[i__1].r = 1., a[i__1].i = 0.;
		i__1 = *m - i__;
		i__2 = *n - i__ + 1;
		d_cnjg(&z__1, &tau[i__]);
		zlarf_("Right", &i__1, &i__2, &a_ref(i__, i__), lda, &z__1, &
			a_ref(i__ + 1, i__), lda, &work[1]);
	    }
	    i__1 = *n - i__;
	    i__2 = i__;
	    z__1.r = -tau[i__2].r, z__1.i = -tau[i__2].i;
	    zscal_(&i__1, &z__1, &a_ref(i__, i__ + 1), lda);
	    i__1 = *n - i__;
	    zlacgv_(&i__1, &a_ref(i__, i__ + 1), lda);
	}
	i__1 = a_subscr(i__, i__);
...
/*     Use unblocked code for the last or only block. */
	...
	i__2 = *n - kk;
	i__3 = *k - kk;
	zungl2_(&i__1, &i__2, &i__3, &a_ref(kk + 1, kk + 1), lda, &tau[kk + 1]
		, &work[1], &iinfo);
    }
...
/*              Form the triangular factor of the block reflector   
		...
		i__2 = *n - i__ + 1;
		zlarft_("Forward", "Rowwise", &i__2, &ib, &a_ref(i__, i__), 
			lda, &tau[i__], &work[1], &ldwork);
...
/*           Apply H' to columns i:n of current block */
	    ...
	    i__2 = *n - i__ + 1;
	    zungl2_(&ib, &i__2, &ib, &a_ref(i__, i__), lda, &tau[i__], &work[
		    1], &iinfo);
...
/*        Apply H(i) or H(i)' */
	...
	i__3 = a_subscr(nq - *k + i__, i__);
	aii.r = a[i__3].r, aii.i = a[i__3].i;
	i__3 = a_subscr(nq - *k + i__, i__);
	a[i__3].r = 1., a[i__3].i = 0.;
	zlarf_(side, &mi, &ni, &a_ref(1, i__), &c__1, &taui, &c__[c_offset], 
		ldc, &work[1]);
	i__3 = a_subscr(nq - *k + i__, i__);
...
/*        Apply H(i) or H(i)' */
	...
	if (i__ < nq) {
	    i__3 = nq - i__;
	    zlacgv_(&i__3, &a_ref(i__, i__ + 1), lda);
	}
	i__3 = a_subscr(i__, i__);
	aii.r = a[i__3].r, aii.i = a[i__3].i;
	i__3 = a_subscr(i__, i__);
	a[i__3].r = 1., a[i__3].i = 0.;
	zlarf_(side, &mi, &ni, &a_ref(i__, i__), lda, &taui, &c___ref(ic, jc),
		 ldc, &work[1]);
	i__3 = a_subscr(i__, i__);
	a[i__3].r = aii.r, a[i__3].i = aii.i;
	if (i__ < nq) {
