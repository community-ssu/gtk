...
extern __typeof (gdk_draw_rectangle_alpha_libgtk_only) IA__gdk_draw_rectangle_alpha_libgtk_only __attribute((visibility("hidden")));
extern __typeof (gdk_draw_rectangle_alpha_libgtk_only) gdk_draw_rectangle_alpha_libgtk_only __attribute((alias("IA__gdk_draw_rectangle_alpha_libgtk_only"), visibility("default")));
#define gdk_draw_rectangle_alpha_libgtk_only IA__gdk_draw_rectangle_alpha_libgtk_only
...
extern __typeof (gdk_rectangle_get_type) IA__gdk_rectangle_get_type __attribute((visibility("hidden"))) G_GNUC_CONST;
...
extern __typeof (gdk_x11_display_get_user_time_libgtk_only) IA__gdk_x11_display_get_user_time_libgtk_only __attribute((visibility("hidden")));
extern __typeof (gdk_x11_display_get_user_time_libgtk_only) gdk_x11_display_get_user_time_libgtk_only __attribute((alias("IA__gdk_x11_display_get_user_time_libgtk_only"), visibility("default")));
#define gdk_x11_display_get_user_time_libgtk_only IA__gdk_x11_display_get_user_time_libgtk_only
