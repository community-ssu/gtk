/* Note that the filesystem module must be installed for this to work. */
...
main (int argc, char **argv)
{
  ...
  /* This is useful when testing without gnome running, otherwise the default
   * icons won't work. Don't copy this code.
   */
  settings = gtk_settings_get_default ();
  /*g_object_set (settings, "gtk-icon-theme-name", "gnome", NULL);*/
  
  dialog = g_object_new (GTK_TYPE_FILE_CHOOSER_DIALOG,
			 "action", 1 ? GTK_FILE_CHOOSER_ACTION_OPEN : GTK_FILE_CHOOSER_ACTION_CREATE_FOLDER,
