...
GnomeVFSURI *
om_vfs_utils_create_uri_without_trailing_slash (const GnomeVFSURI *uri)
{
	GnomeVFSURI *new_uri;
	GnomeVFSURI *p;
...
gboolean
om_vfs_utils_uri_case_equal (gconstpointer a, gconstpointer b)
{
...
guint
om_vfs_utils_uri_case_hash (gconstpointer p)
{
