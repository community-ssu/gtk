...
docstring="""docstring goes here"""

def alert(text, buttons=gtk.BUTTONS_NONE, type=gtk.MESSAGE_INFO):
    md = gtk.MessageDialog(buttons=buttons, \
            type=type)
...
class BluezChatGui:
    def __init__(self):
        ...
        self.discovered = gtk.ListStore(gobject.TYPE_PYOBJECT, 
               gobject.TYPE_STRING, gobject.TYPE_STRING)
        self.devices_tv.set_model(self.discovered)
        renderer = gtk.CellRendererText()
        column1=gtk.TreeViewColumn("addr", renderer, text=1)
        column2=gtk.TreeViewColumn("name", renderer, text=2)
        ...
        self.chat_button.set_sensitive(gtk.FALSE)
...
# --- gui signal handlers
    ...
    def scan_button_clicked(self, widget):
        self.quit_button.set_sensitive(gtk.FALSE)
        self.scan_button.set_sensitive(gtk.FALSE)
#        self.chat_button.set_sensitive(gtk.FALSE)
...
#            self.add_text("\ndiscovered [%s]" % addr)
        ...
        self.quit_button.set_sensitive(gtk.TRUE)
        self.scan_button.set_sensitive(gtk.TRUE)
#        self.chat_button.set_sensitive(gtk.TRUE)
...
# --- other stuff
    ...
    def start_server(self):
        ...
        self.server_sock.bind(("00:00:00:00:00:00",0x1001))
